...
//Import Classes
//import { SoftHardware } from "./SoftHardware";

//let types:SoftHardware;
...
function getSoftware() {
	var data = null;
	//data.append("operation","{\"type\":\"Sequence\",\"version\":\"2\",\"operations\":[{\"type\":\"Add\",\"version\":\"2\",\"operationScope\":{\"type\":\"QueryOperationScope\",\"parentTxtureId\":\"t:00000000-0000-0000-0000-000000000000\",\"query\":{\"type\":\"AllEntities\"}},\"operationType\":\"HIDDEN\"},{\"type\":\"Filter\",\"operationScope\":{\"type\":\"QueryOperationScope\",\"parentTxtureId\":\"t:00000000-0000-0000-0000-000000000000\",\"query\":{\"type\":\"EntitiesByEntityClass\",\"entityClassTxtureIds\":[\"t:1e701175-116f-4e10-8e07-a834364ac99d\"]}},\"version\":\"2\"}]}");
	
	var xhr = createXMLReq();
	
	var txtureID = encodeURIComponent(typeMap.get(agent.query));
	console.log("getsoftware txture id"+ txtureID);
	var url = "https://htwg-konstanz.txture.io/api/v8/query/master/1567680979092?operation=%7B%22type%22%3A%22Sequence%22%2C%22version%22%3A%222%22%2C%22operations%22%3A%5B%7B%22type%22%3A%22Add%22%2C%22version%22%3A%222%22%2C%22operationScope%22%3A%7B%22type%22%3A%22QueryOperationScope%22%2C%22parentTxtureId%22%3A%22t%3A00000000-0000-0000-0000-000000000000%22%2C%22query%22%3A%7B%22type%22%3A%22AllEntities%22%7D%7D%2C%22operationType%22%3A%22HIDDEN%22%7D%2C%7B%22type%22%3A%22Filter%22%2C%22operationScope%22%3A%7B%22type%22%3A%22QueryOperationScope%22%2C%22parentTxtureId%22%3A%22t%3A00000000-0000-0000-0000-000000000000%22%2C%22query%22%3A%7B%22type%22%3A%22EntitiesByEntityClass%22%2C%22entityClassTxtureIds%22%3A%5B%22"+txtureID+"%22%5D%7D%7D%2C%22version%22%3A%222%22%7D%5D%7D";
	xhr.open("POST", url);
	xhr.setRequestHeader("cache-control", "no-cache");
	...
	return new Promise((resolve, reject) => {
		...
		xhr.onreadystatechange = function () {
			if (xhr.readyState === 4 && xhr.status === 200) {
				...
				console.log("innerhalbt readystae =4");
				
				var result = JSON.parse(xhr.responseText);
				console.log(xhr.responseText);
	/*			agent.add(xhr.responseText);
				agent.add("Vor der Map");
				//Iterate over map keys
				for (let [key,value] of typeMap) {
					agent.add(key, value);
				}*/
				agent.add("agentquery "+agent.query);
				agent.add("txtureID of   "+agent.query+"  "+typeMap.get(agent.query));
				resolve();
			}
		};
	});
